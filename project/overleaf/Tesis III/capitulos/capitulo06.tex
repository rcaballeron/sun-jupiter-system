...
Por último, podemos calcular el factor de relleno de una estrella aplicando el ajuste realizado por \cite{Gallet2013} que reproduce más fielmente el factor de relleno del Sol $\fsun$ ([0.001-0.01], ver \citep{Cranmer2011}),
...
Con este formalismo podemos calcular $\Bp$ como una función dependiente del tiempo, de $\rho$, $\teff$, y $\Omega$. Los valores temporales de estas tres variables se obtendrán a partir de las distintas simulaciones realizadas con ayuda de MESA. \par
...
--INTRODUCIR POR QUÉ SE UTILIZÓ ESTA NUEVA VERSIÓN. HACER REFERENCIA A LA FIGURA EN LA QUE SE MOSTRABAN LOS DIENTES DE SIERRA.
