...
A lo largo de la evolución de la estrella, parámetros directamente observables como su velocidad de rotación, temperatura efectiva, gravedad superficial o abundancia de elementos químicos sufren variaciones. Estos parámetros ejercen una influencia, directa o indirecta, en AML causada por el campo magnético de la estrella. Además, nos encontramos con los movimientos de convección estelar, que en la mayoría de los modelos de evolución estelar, se describen mediante la teoría de la longitud de mezcla (MLT). La MLT utiliza la escala de longitud de mezcla, que es proporcional a la altura de la escala de presión local y al parámetro de longitud de mezcla ($\amlt$). Este parámetro, $\amlt$, se considera un parámetro fijo libre y debe determinarse comparando los modelos estelares con alguna referencia, en la mayoría de los casos nuestro Sol. Por lo tanto, suponer que la intensidad del campo magnético ($B$) y $\amlt$ permanecen constantes a lo largo de la evolución estelar es una simplificación necesaria en algunos escenarios, pero no se corresponde con la realidad.\par

En los últimos años, se ha estudiado la evolución rotacional de estrellas de masa baja e intermedia gracias a varias campañas observacionales \citep{Hartman2010, Gallet2013, Bouvier2016}. Algunas investigaciones específicas, como las de \citet{Ud-Doula2008, Cranmer2011, Gallet2015, Amard2016}, se centran en modelar los efectos del MB y su acoplamiento con los vientos estelares en la evolución rotacional de las estrellas. Estos modelos se basan en una serie de parámetros que son fijos, entre ellos la intensidad del campo magnético $B$. Este enfoque ha demostrado no ser suficiente para explicar los datos observacionales, y es necesaria la interacción con otros procesos en la evolución de la velocidad angular de las estrellas de baja masa: por ejemplo la distribución de AML en el interior de la estrella a lo largo de la PMS y MS \citep{Charbonnel2005, Eggenberger2008, Eggenberger2009, Caballero2020}, y la interacción estrella-disco protoestelar durante la PMS \citep{Bouvier2008,Gallet2013,Eggenberger2012,Zanni2012,Bouvier2016}.\par

Atendiendo a este contexto, extendemos nuestra línea de investigación en la dirección de explorar cómo contribuyen los modelos estelares evolutivos en los que tanto $B$ como $\amlt$ varían con el tiempo en función de parámetros estelares específicos al MB y a la evolución del Li en el Sol, y otras estrellas de tipo solar.\par
