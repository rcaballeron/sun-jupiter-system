...
! ***********************************************************************
      ...
      subroutine do_starlib_init( &
         ...
         real(dp), intent(in) :: &
            kappa_blend_logT_upper_bdy, kappa_blend_logT_lower_bdy, &
            kappa_type2_logT_lower_bdy, reaclib_min_T9
      ...
      integer function star_finish_step( &
         ...
         integer, intent(out) :: ierr
         star_finish_step = &
            finish_step(id, id_extra, do_photo, ierr)
      ...
      subroutine get_data_for_profile_columns(s, id_extra, &
         ...
         integer, intent(out) :: ierr
         call do_get_data_for_profile_columns(s, id_extra, nz, &
      ...
      subroutine star_write_stella_data(id, &
            fname, &
            min_surf_logRho, &
            min_velocity, &
            skip_inner_dm, &
            ...
            v_CSM, &
            show_headers, ierr)
         use do_one_utils, only: write_stella_files
         integer, intent(in) :: &
            id, num_points, nz_extra
         ...
         call write_stella_files(s, &
            ...
            v_CSM, &
            show_headers, ierr)
      end subroutine star_write_stella_data

      
      subroutine star_set_vars(id, id_extra, dt, ierr)
      ...
      subroutine save_profile(id, id_extra, priority, ierr)
         ...
         call do_save_profiles(s, id_extra, ierr)
      ...
      subroutine star_total_energy_integrals(id, &
            ...
            total_linear_kinetic_energy, total_rotational_kinetic_energy, &
            sum_total, ierr)
      ...
      subroutine star_remove_surface_by_temperature(id, temperature, ierr)
         use remove_shells, only: do_remove_surface_by_temperature
         integer, intent(in) :: id
         real(dp), intent(in) :: temperature
         integer, intent(out) :: ierr
         call do_remove_surface_by_temperature(id, temperature, ierr)      
      end subroutine star_remove_surface_by_temperature
      ...
      subroutine star_retain_fallback(id, ierr)
         use remove_shells, only: do_retain_fallback
         integer, intent(in) :: id
         integer, intent(out) :: ierr
         call do_retain_fallback(id, ierr)      
      end subroutine star_retain_fallback
